...
BOOST_PYTHON_MODULE(dyros_robot_controller_cpp_wrapper)
{
    ...
    bp::class_<MM_RC, boost::noncopyable>("MobileManipulatorRobotController", bp::init<std::shared_ptr<MM_RD>>())
        ...
        .def("setQPIKGain", static_cast<void (MM_RC::*)(const Vector6d&, const Eigen::Ref<const VectorXd>&, const Eigen::Ref<const VectorXd>&, const Eigen::Vector3d&)>(&MM_RC::setQPIKGain))
        .def("setQPIKGain", static_cast<void (MM_RC::*)(const std::map<std::string, Vector6d>&, const Eigen::Ref<const VectorXd>&, const Eigen::Ref<const VectorXd>&, const Eigen::Vector3d&)>(&MM_RC::setQPIKGain))
        ...
        .def("setQPIDGain", static_cast<void (MM_RC::*)(const Vector6d&, const Eigen::Ref<const VectorXd>&, const Eigen::Ref<const VectorXd>&, const Eigen::Vector3d&, const Eigen::Vector3d&, const Eigen::Ref<const VectorXd>&)>(&MM_RC::setQPIDGain))
        .def("setQPIDGain", static_cast<void (MM_RC::*)(const std::map<std::string, Vector6d>&, const Eigen::Ref<const VectorXd>&, const Eigen::Ref<const VectorXd>&, const Eigen::Vector3d&, const Eigen::Vector3d&, const Eigen::Ref<const VectorXd>&)>(&MM_RC::setQPIDGain))
